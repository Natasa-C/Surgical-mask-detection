...
class Problem():
    ...
    def extractFeaturesForDataSet(self, set_of_data, names_for_data, filename):
        ...
        to_append += f'mean_magnitude,mean_freq,mean_chroma_stft,mean_rms,mean_bank,mean_mel,mean_spectral_contrast'
        g = open(filename, 'w')
        g.write(to_append)
        g.close()
    ...
    def extractFeaturesAllData(self):
        ...
        self.VALIDATION_FEATURES_PATH = self.CSV_FILES_FOLDER_PATH + self.VALIDATION_FEATURES_PATH
