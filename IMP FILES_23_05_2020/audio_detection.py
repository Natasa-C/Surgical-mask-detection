...
class Problem():
    ...
    def kerasNeuralNetwork(self):
        ...
        model = Sequential()
        model.add(Dense(15, input_dim=12, activation='relu')) # input layer requires input_dim param
        ...
        model.fit(self.train_features, self.train_labels, epochs = 1000, batch_size=20, validation_data=(self.validation_features, self.validation_labels))
